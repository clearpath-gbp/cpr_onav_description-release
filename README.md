## cpr_onav_description (noetic) - 0.1.12-1

The packages in the `cpr_onav_description` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -t noetic -r noetic cpr_onav_description` on `Mon, 27 May 2024 16:13:14 -0000`
...
## cpr_onav_description (noetic) - 0.1.9-1

The packages in the `cpr_onav_description` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -t noetic -r noetic cpr_onav_description` on `Fri, 29 Sep 2023 18:35:35 -0000`
...
## cpr_onav_description (noetic) - 0.1.8-1

The packages in the `cpr_onav_description` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -t noetic -r noetic cpr_onav_description` on `Mon, 18 Sep 2023 20:19:27 -0000`
...
## cpr_onav_description (noetic) - 0.1.7-1

The packages in the `cpr_onav_description` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -t noetic -r noetic cpr_onav_description` on `Fri, 08 Sep 2023 19:12:56 -0000`
...
## cpr_onav_description (noetic) - 0.1.6-1

The packages in the `cpr_onav_description` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -t noetic -r noetic cpr_onav_description` on `Thu, 24 Aug 2023 18:40:32 -0000`
...
## cpr_onav_description (noetic) - 0.1.5-3

The packages in the `cpr_onav_description` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -t noetic -r noetic cpr_onav_description` on `Thu, 24 Aug 2023 18:34:47 -0000`
...
## cpr_onav_description (noetic) - 0.1.5-2
